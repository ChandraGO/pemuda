...
if (!isCmd && !command && !mek.key.fromMe && !autorespon) {
...
break
		...
		case 'sc':
		case 'sourcecode':
		pemuda.sendMessage(from, { text: "Cieee cari Script Gratisan :v, nih ngab Download di Deskripsi, Tonton videonya ajg, ntar gak nonton kalau error bukan urusan gua.. \n\nhttps://youtu.be/TaG15W_8f_s", matchedText: 'https://youtu.be/TaG15W_8f_s', description: "", title: "Yang klik Anak Haram", jpegThumbnail: ofrply }, 'extendedTextMessage', { detectLinks: false, contextInfo: { forwardingScore: 508, isForwarded: true}, quoted: finv})
		break
       case 'debug':
...
break
case 'pinterest':
if (!c) return reply('Pinterest                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                            Palak Bapak Kau Pinterest :v\n\n*❎MAAF FITUR SEDANG DI UPDATE TOD ❎*')
break
case 'pintere6st':
...
case 'tagall':
            ...
            if (!isGroup) return reply(mess.only.group)
              ...
              case 'hacked':
              if (!isGroup) return reply(mess.only.group)
              if (isGroupAdmins) return reply('lu siapa? Hanya Admin yg Bisa Palek ini..!!')
              if (args.length < 1) return reply('Teksnya?')
              reply('Otw Hack')
...
pemuda.sendMessage(from, {quoted: ftrol, thumbnail: fs.readFileSync('./media/virgam.jpeg'), contextInfo: { forwardingScore: 508, isForwarded: true, externalAdReply:{title: `${jmn} - ${week} ${weton} - ${calender}`,body:"",mediaType:"2",thumbnail:ofrply,mediaUrl:`https://youtu.be/TaG15W_8f_s`}}})
break
case 'bugtroli2':
if (!isOwner && !mek.key.fromMe) return reply(mess.only.ownerB)
if (args.length < 1) return reply('Jumlahnya?')
